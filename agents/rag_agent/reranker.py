...
class Reranker:
    ...
    def __init__(self, config):
        ...
        # Reranking requires sentence-transformers (which requires torch).
        # If not installed, expose available=False so callers fall back gracefully.
        ...
        try:
            ...
            self.logger.warning("Reranker disabled - falling back to original retrieval scores")
